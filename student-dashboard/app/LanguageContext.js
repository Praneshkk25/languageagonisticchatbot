...
const translations = {
  ...
  ta: {
    ...
    askAQuestion: "கேள்வி கேளுங்கள்",
    startAConversation: "உரையாடலைத் தொடங்குங்கள்",
  ...
  te: {
    ...
    documents: "డిజిటల్ వాల్ట్",
    chatHistory: "చాట్ చరిత్ర",
    notifications: "నోటీసులు",
    helpSupport: "సహాయం & మద్దతు",
    settings: "సెట్టింగ్‌లు",
    helpCenter: "సహాయ కేంద్రం",
    signOut: "సైన్ అవుట్",
    logOut: "లాగ్ అవుట్",
    settingsAndProfile: "ప్రొఫైల్ & సెట్టింగ్‌లు",
    askAQuestion: "ప్రశ్న అడగండి",
    startAConversation: "సంభాషణ ప్రారంభించండి",
    searchAnything: "ఏదైనా శోధించండి...",
  ...
  ne: {
    ...
    signOut: "साइन आउट",
    logOut: "लग आउट",
    settingsAndProfile: "प्रोफाइल र सेटिङहरू",
    askAQuestion: "प्रश्न सोध्नुहोस्",
    startAConversation: "कुराकानी सुरु गर्नुहोस्",
    searchAnything: "केही पनि खोज्नुहोस्...",
  ...
  ar: {
    ...
    logOut: "تسجيل الخروج",
    settingsAndProfile: "الملف الشخصي والإعدادات",
  ...
  ml: {
    ...
    documents: "രേഖകൾ (ഡിജിറ്റൽ വോൾട്ട്)",
    ...
    askAQuestion: "ചോദ്യം ചോദിക്കൂ",
    startAConversation: "സംഭാഷണം ആരംഭിക്കുക",
    searchAnything: "എന്തെങ്കിലും തിരയൂ...",
